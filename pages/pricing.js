  ...
  return (
    <>
      ...
      <section className="container mt2">
        ...
        <p className="subtle">
          As a new starter in the market, we’re offering reduced pricing for early adopters. <strong>Lock in your
          plan today — these rates won’t last forever.</strong>
        </p>

        {/* Desktop: 3 columns, Mobile: rows */}
        ...
        {/* Component-scoped CSS to guarantee layout even if globals are unchanged */}
        <style jsx>{`
          .pricing-grid{
            display:grid;
          ...
          @media (max-width: 860px){
            .pricing-grid{
              grid-template-columns: 1fr; /* rows on mobile */
              gap: 1.25rem;
            }
            .pricing-card{
              width:100%;
